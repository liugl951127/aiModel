...
> **目标**: Windows / Linux / macOS 都能**一条命令**拉起 7 个中间件
> **适用**: 部署 AI Platform 完整版 (11 微服务 + 7 中间件)
...
| 3 | **Seata Server** | `seataio/seata-server:2.0.0` | 7091, 8091 | 分布式事务 TC |
| 4 | **Nginx** | `nginx:alpine` | 8080 | 前端代理 (网关入口) |
| 5 | **Prometheus** | `prom/prometheus:v2.50.0` | 9090 | 指标采集 |
| 6 | **Grafana** | `grafana/grafana:10.4.0` | 3000 | 可视化 (admin/admin) |
...
✓ 7 个端口 (8080/8848/9200/3000/7091/9090/11434) 全部空闲
====================================================  启动 7 个中间件  ====================================================
[+] Running 7/7
...
|---|---|---|---|
| 启动 | `bash deploy-middleware.sh` | `.\deploy-middleware.ps1` | 启动 7 个中间件 |
...
| 健康检查 | `bash deploy-middleware.sh health` | `.\deploy-middleware.ps1 health` | 7 个 URL 检查 |
...
│   │   └── alerts.yml
│   ├── helm/                          K8s Helm chart
│   └── middleware/                    ★ 7 个中间件 (本目录)
│       ├── docker-compose.yml         7 个中间件编排
...
```powershell
# PowerShell admin
New-NetFirewallRule -DisplayName "Docker" -Direction Inbound -Enabled True -Protocol TCP -LocalPort 8080,3000,9090,9200,8848,7091,11434 -Action Allow
```
