...
-- Default tenant
INSERT IGNORE INTO sys_tenant (id, tenant_code, tenant_name, contact_name, contact_email, status, plan_code, max_users)
...
INSERT IGNORE INTO sys_user (id, tenant_id, username, password, nickname, email, status, department, is_super_admin)
VALUES (1, 1, 'admin', '$2a$10$4Wv4SlzLLYBNG7Y88Kcmq.FpJb58h7pcMExwGlFDY.Cw4eznHUIbe', '管理员', 'admin@example.com', 1, '技术部', 1);

-- Default agent
INSERT IGNORE INTO agent_agent (id, tenant_id, agent_code, agent_name, agent_type, description, system_prompt, tools, model_code, temperature, max_steps, status)
...
INSERT IGNORE INTO kb_base (id, tenant_id, kb_code, kb_name, description, index_name, status, embedding_model)
VALUES (1, 1, 'KB-DEFAULT', '默认知识库', '平台使用手册与常见问题', 'kb-default', 1, 'byte-hash');

-- Sample role
INSERT IGNORE INTO sys_role (id, tenant_id, role_code, role_name, description, status)
VALUES (1, 1, 'PLATFORM_ADMIN', '平台管理员', '系统超级管理员', 1);


-- 示例公司（可由用户自由切换体验）
INSERT IGNORE INTO sys_tenant (id, tenant_code, tenant_name, contact_name, contact_email, status, plan_code, max_users) VALUES
...
INSERT IGNORE INTO sys_user (id, tenant_id, username, password, nickname, email, status, department) VALUES
...
INSERT IGNORE INTO sys_user_tenant (id, user_id, tenant_id, role_in_tenant, is_default) VALUES
    (1, 1, 1, 'owner', 1),
    (2, 1, 2, 'admin', 0),
    (3, 1, 3, 'admin', 0),
    (4, 2, 1, 'member', 1),
...
-- demo/manager: user
INSERT IGNORE INTO sys_user_role (id, user_id, role_id, tenant_id) VALUES
    (1, 1, 1, 1),
    (2, 2, 1, 1),
    (3, 3, 1, 2);
...
INSERT IGNORE INTO biz_customer (id, tenant_id, name, industry, scale, contact_name, contact_phone, contact_email, level, owner_user_id, notes) VALUES
...
INSERT IGNORE INTO biz_chat (customer_id, owner_user_id, subject, type, status, next_step, next_date, summary) VALUES
...
INSERT IGNORE INTO biz_opportunity (customer_id, name, amount, stage, probability, expected_date, owner_user_id) VALUES
...
INSERT IGNORE INTO biz_quote (id, customer_id, opportunity_id, code, title, total_amount, discount, final_amount, status) VALUES
...
INSERT IGNORE INTO biz_contract (id, customer_id, opportunity_id, quote_id, code, title, amount, sign_date, start_date, end_date, status) VALUES
(1, 1, 1, 1, 'C-2026-0001', '阿里云年度服务合同', 1200000.00, '2026-06-15', '2026-07-01', '2027-06-30', '执行中');

INSERT IGNORE INTO biz_order (id, customer_id, contract_id, code, amount, paid, status) VALUES
(1, 1, 1, 'O-2026-0001', 1200000.00, 600000.00, '部分付款');

INSERT IGNORE INTO biz_payment (order_id, amount, method, status, paid_at) VALUES
(1, 600000.00, '银行转账', '已收款', '2026-06-15 10:00:00');

INSERT IGNORE INTO biz_product (code, name, category, price, unit, description, stock) VALUES
...
INSERT IGNORE INTO biz_service (code, name, category, price, description, sla_hours) VALUES
('S-IMPL', '实施服务', '咨询', 50000.00, '现场实施, 含培训', 72),
('S-CONSULT', '专家咨询', '咨询', 5000.00, '1 对 1 专家, 按天', 24),
('S-SUPPORT', '技术支持', '运维', 10000.00, '7x24 优先支持, 按月', 4);

INSERT IGNORE INTO biz_expense (order_id, category, amount, happened_at, notes, created_by) VALUES
...
-- 多智能体案例库 (3 个示例, 首页推荐)
INSERT IGNORE INTO agent_multi_agent_case (id, case_key, title, summary, description, domain, agent_spec, flow_spec, final_output, kpis, featured, tenant_id) VALUES
(1, 'rag-qa-demo', '企业知识库问答', '基于 RAG 的内部知识库智能问答系统',
 ...
 '{"accuracy":0.92,"latency_ms":850,"refusal_rate":0.05}', 1, 1),
(2, 'marketing-copy', '营销文案生成', '从产品白皮书一键生成小红书/公众号/抖音 3 平台文案',
 ...
 '{"engagement_lift":0.45,"cost_per_copy":0.02}', 0, 1),
(3, 'legal-review', '合同风险审查', '上传合同 PDF, AI 自动标出风险条款并给出修改建议',
 ...
 '{"accuracy":0.89,"false_positive":0.07}', 0, 1);
